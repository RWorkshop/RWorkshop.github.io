...
1. Prepare a table with mean, standard deviation and coefficient of variance (CV) of the claims paid
...
<p>
3.  Prepare a contingency table identifying the proportion of insured across different CLASS(es) for each gender. Test the null hypothesis “There is no relationship between the GENDER and the CLASS of the insured” against an alternate hypothesis of
existence of significant relation at 95% confidence level. Perform an appropriate test and comment. 
<p>
