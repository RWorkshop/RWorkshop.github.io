...
1. Prepare a table with mean, standard deviation and coefficient of variance (CV) of the
claims paid
...
3.  Prepare a contingency table identifying the proportion of insured across different
...
2. Plot a histogram of “PAID” data with 30 equal class intervals. Superimpose the
histogram with the Probability Density Functions of the above four distributions using
their estimated parameters obtained in exercise 1. 
Mark each plot distinctly using an appropriate legend. 

3. Compute the 5th percentile, 1st quartile, median, 3rd quartile and 95th percentile of both
the actual claims paid as well as from the fitted distributions. 

4. Using the results from exercises 2 and 3, comment on goodness-of-fit of the models to the
data. 
