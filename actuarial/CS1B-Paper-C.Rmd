...
Your answer should include a summary of the principal component analysis. Suggest with reasons, using the output of the R analysis, how many 
...
portfolio. 
1.  Construct a plot of the logarithm of the number of policies (on the y
axis) against the class of business. Comment on the relationship in the data based on your plot.
<p>
In the plot produced in exercise  1.  we can distinguish between male and female policyholders. 
