...
All others Medium
4.  Use the contingency table provided in 4(3.  above and test for the independence of 
...
v1.  Comment on the appropriateness of the model fitted. 
...
v2.   Update the model fitted in (2.   above, as suggested by your friend and display the summary 
of the model. of $Y$
v3.  Compare the models in (2.   and (v2.   using an appropriate test and comment on the 
