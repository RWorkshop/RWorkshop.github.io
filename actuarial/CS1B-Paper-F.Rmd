...
(BMIClaims.csv)
 ...
 #### Exercises
1. Obtain 95% confidence interval for the standard deviation of BMI (using <tt>qchisq()</tt>). 
...
3.  Fit a linear regression model for dependent variable ***log(ILI)***, and Summarize it. 
...
7.  Based on the linear regression model fitted in exercise 3, what is the estimate for the percentage of ILI-related physician visits for the week computed in part 6.  ? 
8.  What is the relative error between the estimate (prediction calculated in part 7 and the actual observed value for the week computed in part 6 ? 
