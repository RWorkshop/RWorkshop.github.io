...
8.  What is the relative error between the estimate (prediction calculated in exercise 7) and the actual observed value for the week computed in exercise 6 ? 
