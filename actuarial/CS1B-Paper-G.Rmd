...
5.  (a) Plot a scatterplot of the transformed data. 
...
produced in exercise s 5. (a) and 5. (b). 
...
3. Perform the test specified in exercise  2. , ignoring that the two markers have 
marked the same exam paper. 
4.  Comment on your conclusions from parts 2.  and 3. . 
5.  Comment on the issues arising when analysing paired data as independent 
...
1.  (a) Calculate the mean and the standard deviation for Alice’s prior
distribution. 
...
. 
4.  (a) Plot the posterior density of p by adding it to the plot in exercise  3. . 
...
(c) Compare your answer in exercise  (vii)(b) with your answer in exercise  6. . 
...
model in exercise  1. (c). Label this model as Model1. Your answer should 
...
parts 1. (a) and 1. (b). [8] 
(b) Comment on your answer in exercise  4. (a). [1]
5.  (a) Draw a suitable plot, for the residuals of Model3, for checking the 
model’s validity. 
(b) Comment on the plot in exercise  5. (a). 
 [6] 
