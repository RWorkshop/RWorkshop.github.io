...
v1.  Calculate the 95% confidence interval for systolic blood pressure using the posterior 
distribution. 
### Question 3
...
v1.  State the proportion of the total variability of the responses explained by the model based 
on your output in (4.. 
v2.   Plot a graph of the residuals of the model fitted in (4. against the explanatory variable. 
v3.  Obtain a 99% confidence interval for parameter sigma. 
ix) Comment on the validity of the model based on results in part v2.   and part (v3. . 
