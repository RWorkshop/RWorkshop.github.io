...
Q. 4) For a sample data X = 0.5820, 0.04981, 0.1552, 0.1555, 0.9036, 0.8501, 0.9288, 0.4408, 
0.9688, 0.6300
...
Provide your interpretation of the model by explaining R-Squared, Adjusted R-Squared & p-value of the model. Identify the significant variables in the prediction 
...
additional explanatory variables to the set of independent variables taken in (1.  for 
...
5.  One of your friend working with Actuarial consulting firm told you that natural 
