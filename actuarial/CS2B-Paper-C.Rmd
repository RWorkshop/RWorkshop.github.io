...
3.    (a) Plot the sample Autocorrelation function (ACF) and sample Partial Autocorrelation function (PACF) of the original data, giving 
...
<p>
5.  (a) Propose an appropriate model for the transformed data. 
