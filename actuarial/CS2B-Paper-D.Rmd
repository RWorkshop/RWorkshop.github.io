...
#### Exercises 
1.  Plot the data as time series with ***frequency =12*** (i.e. 12 months). 
...
and frequency.
$$xt = A cos(2π\omega t + \phi) + wt,$$ where $\omega$  is equal to 1/50 and wt is the white noise with mean 
...
$$
A cos(2π\omega t + \phi) = A cos(\phi) cos(2π\omega t) - A sin(\phi) sin(2π\omega t),\\
...
2.   Use the results of the summary created in exercise 1 and input the values of tj, dj and nj in the 
