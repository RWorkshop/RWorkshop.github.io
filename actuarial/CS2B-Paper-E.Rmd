...
9. Comment on the results in exercise s (vii) and (viii), including whether they agree 
...
***group_label_stage2***.  
7. Comment on the matrix generated in exercise  (vi) with reference to how the cluster labels have changed between ***group_label_stage1*** and ***group_label_stage2***.  
